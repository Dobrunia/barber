	...
	return (
		...
		>
			...
			<div className="flex flex-wrap justify-start">
				...
				<div
					className="absolute right-8 top-1/2 -translate-y-[100%] w-[60px] h-[100px] rounded-img bg-[#977656] hover:bg-[#755c43] transition-colors text-white text-[24px] font-bold flex items-center justify-center cursor-pointer max-lg:static max-lg:translate-y-0 max-lg:w-[270px] max-lg:h-[60px] max-lg:mr-[20px] max-lg:mb-[20px]"
