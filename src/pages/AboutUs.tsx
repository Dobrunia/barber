    ...
    >
      <div className="flex items-center justify-around w-full h-full max-small:flex-col max-small:h-max">
        ...
        >
          ...
          >
            <img className="w-[636px] max-small:w-[320px]" src="/2.png" alt="" />
            <img className="w-[636px] max-small:w-[320px]" src="/slider_1.jpg" alt="" />
            <img className="w-[636px] max-small:w-[320px]" src="/slider_2.jpg" alt="" />
            <img className="w-[636px] max-small:w-[320px]" src="/slider_3.jpg" alt="" />
            {/* <img src="/111.png" alt="" />
            <img src="/44.png" alt="" /> */}
          </div>
